function [stock_N_opt_rho,stock_N_opt_x_CCO,stock_N_opt_v_CCO,stock_N_opt_v_CCO_annualized,...
    stock_N_opt_x_DRO,stock_N_opt_v_DRO,stock_N_opt_eta1_DRO,stock_N_opt_eta2_DRO,stock_N_opt_v_DRO_annualized] = ...
    func_rho_N_epsilon_delta_order4(epsilon,delta,bound,str_assetclass)
...
[stock_N_opt_X_DRO_upper,stock_N_opt_v_DRO_upper] = order4_solver(d,m,rho_0_ini,bound,data);
[stock_N_opt_X_DRO_lower,stock_N_opt_v_DRO_lower] = order4_solver(d,m,rho_1_ini,bound,data);
    ...
    disp('Please increase the initial upper bound of rho: rho_1_ini.');
        ...
        while abs(stock_N_opt_v_DRO - stock_N_opt_v_CCO) > err 
            if rho - (rho_0_ini + rho_1_ini)/2 < 1e-14
                ...
                [stock_N_opt_X_DRO,stock_N_opt_v_DRO] = order4_solver_N(d,m,Sigma,rho,bound);
        ...
        stock_N_opt_x_DRO = stock_N_opt_X_DRO(1:d);
        stock_N_opt_eta1_DRO = stock_N_opt_X_DRO(end-1);
        stock_N_opt_eta2_DRO = stock_N_opt_X_DRO(end);
