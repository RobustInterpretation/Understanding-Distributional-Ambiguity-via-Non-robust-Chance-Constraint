function [stock_T_opt_rho,stock_T_opt_x_CCO,stock_T_opt_v_CCO,stock_T_opt_v_CCO_annualized,...
    stock_T_opt_x_DRO,stock_T_opt_v_DRO,stock_T_opt_eta1_DRO,stock_T_opt_eta2_DRO,stock_T_opt_v_DRO_annualized] = ...
    func_rho_T_epsilon_delta_order4(epsilon,delta,bound,str_assetclass)
...
[stock_T_opt_X_DRO_upper,stock_T_opt_v_DRO_upper] = order4_solver(d,m,rho_0_ini,bound,data);
[stock_T_opt_X_DRO_lower,stock_T_opt_v_DRO_lower] = order4_solver(d,m,rho_1_ini,bound,data);
